...
/*! \defgroup <QUADRATURE_DEMODULATORS> ( Nominal frequency component quadratue demodulators )
 *  \brief the module contains nominal frequency component quadratue demodulators
    @{
*/
...
public:
    ...
    */
    ...
    quad_mltpx() { init( 4000, 50, 60 , 95 , 5 ); }
