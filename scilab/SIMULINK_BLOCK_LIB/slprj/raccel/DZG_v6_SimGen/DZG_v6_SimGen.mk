...
MODEL                = DZG_v6_SimGen
MODULES              = rt_logging.c DZG_v6_SimGen.c DZG_v6_SimGen_capi.c DZG_v6_SimGen_data.c DZG_v6_SimGen_tgtconn.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = DZG_v6_SimGen.exe
MAKEFILE             = DZG_v6_SimGen.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/Александр/YandexDisk/Разработки/#Coding/MatLab/SIMULINK_BLOCK_LIB
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = DZG_v6_SimGen_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/DZG_v6_SimGen \
