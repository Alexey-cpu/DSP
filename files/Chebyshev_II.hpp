...
#ifndef _CHEBYSHEV_II_HPP
#define _CHEBYSHEV_II_HPP
...
public:
	...
	// функция отображения нулей и поюсов фильтра (отладочная, для пользования этой функией надо закоментить кусок с удалением массивов с нулями и полюсами в функции allocate, см. строку 1101 файла cpp):
